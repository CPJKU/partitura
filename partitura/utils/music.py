...
def notes_to_pianoroll(note_array, time_div=8, onset_only=False,
    ...
    notes : structured array
        Strucutred array with pitch, onset and duration information. If the 
...
def _notes_to_pianoroll(note_info, onset_only=False,
                       pitch_margin=-1, time_margin=0,
    ...
    `notes_to_pianoroll` for a complete description of the arguments of
    this function.
    """
...
def pianoroll_to_notearray(pianoroll, time_div=8):
    ...
    time_div : int
        How many sub-divisions for each time unit (see `notes_to_pianoroll`).
