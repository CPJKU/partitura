...
class PartBuilder(object):
    ...
    def add_measure(self, xml_measure):
        ...
        # start: the index of the first divs in vigour inside the measure
        start = np.searchsorted(self.divisions[:, 0], self.current_measure.start.t, side='right')
        # end: the index of the last divs in vigour inside the measure
        ...
        # if there are times beyond the last divs
